...
class ServiceRateCard(models.Model):
    ...
    three_days_cost                          =       models.CharField(max_length=30,blank=True,null=True)
    seven_days_cost                          =       models.CharField(max_length=30,blank=True,null=True)
    thirty_days_cost                         =       models.CharField(max_length=30,blank=True,null=True)
    ninty_days_cost                          =       models.CharField(max_length=30,blank=True,null=True)
    one_eighty_days_cost                     =       models.CharField(max_length=30,blank=True,null=True)
    flag                                =       models.CharField(max_length=15,null=True,blank=True,default=None,choices=status)
    city_place_id                       =       models.ForeignKey(City_Place,blank=True,null=True)
    category_id                         =       models.ForeignKey(Category, blank=True, null=True)
    category_level_1                    =       models.ForeignKey(CategoryLevel1, blank=True, null=True)
    category_level_2                    =       models.ForeignKey(CategoryLevel2, blank=True, null=True)
...
class AdvertRateCard(models.Model):
    ...
    advert_service_name                 =       models.CharField(max_length=30,blank=True,null=True)
    three_days_cost                          =       models.CharField(max_length=30,blank=True,null=True)
    seven_days_cost                          =       models.CharField(max_length=30,blank=True,null=True)
    thirty_days_cost                         =       models.CharField(max_length=30,blank=True,null=True)
    ninty_days_cost                          =       models.CharField(max_length=30,blank=True,null=True)
